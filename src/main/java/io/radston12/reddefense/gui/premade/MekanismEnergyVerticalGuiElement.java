...
import io.radston12.reddefense.energy.EnergyStringHelper;
...
public class MekanismEnergyVerticalGuiElement extends TwoTexturedGuiElement {
    ...
    public MekanismEnergyVerticalGuiElement(int x, int y, EnergyHandler energy) {
        super(x, y, 54, 6, new ResourceLocation(RedDefenseMod.MOD_ID, "gui/elements/horizontal_bar_bg.png"), new ResourceLocation(RedDefenseMod.MOD_ID, "gui/elements/horizontal_power.png"));
