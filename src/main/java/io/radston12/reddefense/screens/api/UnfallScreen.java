...
public abstract class UnfallScreen<T extends UnfallMenu> extends AbstractContainerScreen<T> {
    private static final ResourceLocation BASIC = new ResourceLocation(RedDefenseMod.MOD_ID, "gui/basic_gui.png");
