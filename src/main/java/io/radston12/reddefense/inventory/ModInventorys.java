package io.radston12.reddefense.inventory;

import io.radston12.reddefense.RedDefenseMod;
import io.radston12.reddefense.inventory.custom.ReinforcedInventory;
import io.radston12.reddefense.inventory.custom.UnfallModInventory;
...
public class ModInventorys {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, RedDefenseMod.MOD_ID);
