package io.radston12.unfall.item;

import io.radston12.unfall.UnfallMod;
import io.radston12.unfall.item.api.UnfallItem;
import io.radston12.unfall.item.custom.CompressedBlockOwnerManager;
import io.radston12.unfall.item.custom.CompressedBlockRemover;
import io.radston12.unfall.item.custom.MannerSchnitten;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, UnfallMod.MOD_ID);
