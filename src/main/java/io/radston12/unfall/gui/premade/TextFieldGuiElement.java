...
import io.radston12.unfall.gui.premade.handlers.TextFieldCallback;
...
public class TextFieldGuiElement extends TwoTexturedGuiElement {
    ...
    public TextFieldGuiElement(int offsetX, int offsetYy, int width, TextFieldCallback callback) {
        super(offsetX, offsetYy, width, 22, new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/textfield/marker.png"), new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/textfield/field.png"));
