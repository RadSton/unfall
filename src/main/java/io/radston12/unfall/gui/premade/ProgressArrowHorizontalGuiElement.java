...
import io.radston12.unfall.gui.premade.handlers.PercentageCallback;
...
public class ProgressArrowHorizontalGuiElement extends TwoTexturedGuiElement {
    ...
    public ProgressArrowHorizontalGuiElement(int x, int y, PercentageCallback callback) {
        super(x, y, 26, 8, new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/progress/arrow_horizontal_empty.png"), new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/progress/arrow_horizontal.png"));
