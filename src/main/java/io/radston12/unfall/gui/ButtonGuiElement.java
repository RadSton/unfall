...
import io.radston12.unfall.gui.premade.handlers.ButtonCallback;
...
public class ButtonGuiElement extends TwoTexturedGuiElement {
    ...
    public ButtonGuiElement(int x, int y, ResourceLocation texture, Component component,  ButtonCallback callback) {
        super(x, y, 20, 20, new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/buttons/empty_unmarked.png"), new ResourceLocation(UnfallMod.MOD_ID, "gui/elements/buttons/empty_marked.png"));
