...
import io.radston12.unfall.blocks.api.BlockPropertiesUtils;
...
public class CompressedGlassBlock extends BaseCompressedBlock {
    ...
    public void generateBlockStateProviderData(ModBlockStateProvider provider, RegistryObject<? extends Block> block) {
        ...
        provider.simpleBlock(block.get(), provider.models().withExistingParent(getRegistryName(), new ResourceLocation(UnfallMod.MOD_ID, "block/compressed_cube")).texture("all", all).renderType("translucent"));
    }
